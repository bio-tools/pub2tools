...
public final class Common {
	...
	public static final String LOG_FILE = "pub2tools.log";
	...
	public static final String BIOTOOLS_FILE = "biotools.json";
	...
	public static final String TO_BIOTOOLS_FILE = "to_biotools.json";
	...
	static List<String> getNamesOther(Result2 result, List<Tool> biotools, String biotoolsPrefix) {
