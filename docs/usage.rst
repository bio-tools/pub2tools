...
Calls the same code as the `PubFetcher CLI <https://github.com/edamontology/pubfetcher/wiki/cli>`_ command `-db-init <https://github.com/edamontology/pubfetcher/wiki/cli#database>`_.
